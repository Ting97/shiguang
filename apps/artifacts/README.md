...
产物分发策略（2026-09-21 定）：**小型壳 apk 入库归档；大体积 Expo 原生包（>50MB）不入库（GitHub 单文件 100MB 限制 + 仓库瘦身），挂 [GitHub Releases](https://github.com/Ting97/shiguang/releases) 随 tag 分发**，本地构建后不提交。
