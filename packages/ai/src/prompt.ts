...
- 不适用：「今天喝了两杯咖啡」「吃了顿火锅」等**饮食摄入**——归 diet 域，schedule.applicable=false（除非明确给出起止钟点的聚餐/宴请等活动）
...
- 不适用：「今天喝了两杯咖啡」等**已发生的饮食摄入**——归 diet，todo.applicable=false
...
- **items[].name 必须是简短食物名词**（如"黑咖啡""豆浆""香芋条"），一句话里有多种食物拆成多条；**禁止把整句话或句子片段当 name**
